...
export default function ThemeToggle() {
  ...
  return (
    ...
    >
      {mode === 'dark' ? (
        // Sun icon when in dark mode (click to go to light)
        <svg
        ...
        // Moon icon when in light mode (click to go to system)
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
          viewBox="0 0 24 24"
        ...
        // Combined small sun+moon icon for system mode (click to go to dark)
