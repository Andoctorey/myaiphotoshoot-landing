        ...
        <div className="-mx-4 overflow-x-auto px-4 pb-4 sm:-mx-6 sm:px-6 xl:mx-0 xl:overflow-visible xl:px-0">
          <div className="flex w-max snap-x snap-mandatory gap-4 xl:grid xl:w-full xl:grid-cols-5">
            {showcaseScreenshots.map((screenshot) => (
              <PlatformAppLink
                key={screenshot.src}
                className="group block w-[68vw] max-w-[260px] shrink-0 snap-center overflow-hidden rounded-2xl border border-brand-200/70 bg-brand-950 shadow-lg shadow-brand-900/10 transition duration-300 hover:-translate-y-1 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-4 dark:border-brand-700/50 dark:focus-visible:ring-offset-gray-900 xl:w-auto xl:max-w-none"
