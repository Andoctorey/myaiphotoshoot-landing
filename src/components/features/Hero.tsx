      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(420px,0.95fr)] lg:gap-12">
          ...
          <div className="mx-auto w-full max-w-[640px] lg:max-w-none">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/70 bg-gray-950 shadow-2xl shadow-brand-950/20 ring-1 ring-brand-200/60 dark:border-white/10 dark:ring-brand-700/40">
              <Image
              ...
              <div
                aria-hidden="true"
                className="pointer-events-none absolute inset-0 bg-gradient-to-t from-brand-950/20 via-transparent to-white/5"
              />
            </div>
          </div>
        </div>
